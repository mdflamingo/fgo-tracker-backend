...
// @Failure 400 {object} model.ResponseError "Invalid task ID"
// @Failure 404 {object} model.ResponseError "Task not found"
// @Failure 500 {object} model.ResponseError "Internal Server Error"
...
func (h *TaskHandler) GetTask(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		model.ResponseWithError(w, r, http.StatusBadRequest, "Invalid task ID")
		return
	}
	...
	if err != nil {
		if errors.Is(err, pg.ErrTaskNotFound) {
			...
			model.ResponseWithError(w, r, http.StatusNotFound, "Task not found")
			return
		}
...
// @Success 200
// @Failure 400 {object} model.ResponseError "Invalid request"
// @Failure 404 {object} model.ResponseError "Task not found"
// @Failure 500 {object} model.ResponseError "Internal Server Error"
